<template>
  <footer class="text-center text-white " style="background-color:#23468c; ">
    <div class="container p-4 pb-0">
      <h4>_______________| tuhastore |_______________</h4>
      <section class="mb-4">
        ...
        <a class="btn btn-outline-light btn-floating m-1" href="#!" role="button"><i class="bi bi-messenger"></i></a>
    ...
    <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2);">
      © 2023 Copyright:
      <a class="text-white" href="https://tuha.com/">https://tuha.com</a>
    </div>
